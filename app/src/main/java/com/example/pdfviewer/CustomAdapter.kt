...
class CustomAdapter(private val context: Context, arrayList: ArrayList<String>) : BaseAdapter(), Filterable{
    private lateinit var name: TextView
    private lateinit var fileImage: ImageView
    private var filterArrayList: ArrayList<String>
    ...
    fun getItemAtParticularPosition(position: Int): String {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View? {
        ...
        name.text = filterArrayList[position]
        ...
        return object : Filter() {
            override fun performFiltering(constraint: CharSequence?): FilterResults {
                ...
                val filteredItems = if (query.isNullOrEmpty()) {
                    ...
                    filterArrayList.filter { it.toLowerCase().contains(query) }
                }
            ...
            override fun publishResults(constraint: CharSequence?, results: FilterResults?) {
                ...
                filterArrayList = results?.values as ArrayList<String>
